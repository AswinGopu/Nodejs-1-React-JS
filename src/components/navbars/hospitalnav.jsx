      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="/hprofile">
                PROFILE
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="/bed">
                ADD BED VACANCY
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="/need"></a>
            </li>
          </ul>
