...
export default function Quarntaineable() {
  ...
  const deleteQuarantine = (id) => {
    ...
    fetch("http://localhost/covid/public/api/deletecenter", {
      method: "post",
  ...
  return (
    <>
      <div id="wrapper">
        ...
        <div>
          <a type="submit" className="btn btn-dark mt-2" href="/center">
            +ADD QUARANTINE
          </a>
        </div>
